...
// Kiran: Task 2 additional test cases
it('has correct Token Name and Token Symbol', async() => {
    ...
    assert.equal(tokenName, "StarNotary"); // Assert if the starName property was initialized correctly
    let tokenSymbol = await instance.symbol.call();
    assert.equal(tokenSymbol, "STAR"); // Assert if the starName property was initialized correctly
});
